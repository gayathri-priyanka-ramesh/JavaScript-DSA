/* Sorting Algorithm: Rearrangeing a given array or list of elements according to a comparison operator on the elements
...
export function swap(array, xIndex, yIndex) {
  ...
  // array[xIndex] = array[xIndex] + array[yIndex];
  // array[yIndex] = array[xIndex] - array[yIndex];
  // array[xIndex] = array[xIndex] - array[yIndex];
